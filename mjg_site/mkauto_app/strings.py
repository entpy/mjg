...
class MkautoStrings(object):
    strings = {
        ...
        str("tickle_" + mkauto_consts.event_code["refer_friend"]) + ".discount.content": "Aiutaci a farci conoscere, presentaci a un tuo amico, c'è un premio per entrambi:<br /><b>Il tuo premio</b>: uno sconto del {prize_val}%<br /><b>Il premio per il tuo amico</b>: {extra_prize_value}",
        str("tickle_" + mkauto_consts.event_code["refer_friend"]) + ".bonus.content": "Aiutaci a farci conoscere, presentaci a un tuo amico, c'è un premio per entrambi:<br /><b>Il tuo premio</b>: un bonus di €{prize_val}<br /><b>Il premio per il tuo amico</b>: {extra_prize_value}",
        str("tickle_" + mkauto_consts.event_code["refer_friend"]) + ".text.content": "Aiutaci a farci conoscere, presentaci a un tuo amico, c'è un premio per entrambi:<br /><b>Il tuo premio</b>: {prize_val}<br /><b>Il premio per il tuo amico</b>: {extra_prize_value}",
