...
class MkautoStrings(object):
    strings = {
        ...
        # monthly_prize_bad_start_prize }}}
        # tip_tip1 {{{
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".discount.subject": "[tip_tip1] grazie per la tua registrazione, ecco uno sconto del {prize_val}%",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".bonus.subject": "[tip_tip1] grazie per la tua registrazione, ecco un bonus di €{prize_val}",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".text.subject": "[tip_tip1] grazie per la tua registrazione, ecco {prize_val}",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".discount.title": "[tip_tip1] grazie per la tua registrazione,<br />ecco uno sconto del {prize_val}%",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".bonus.title": "[tip_tip1] grazie per la tua registrazione,<br />ecco un bonus di €{prize_val}",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".text.title": "[tip_tip1] grazie per la tua registrazione, ecco<br />{prize_val}",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".discount.content": "[tip_tip1] Testo per lo sconto {coupon_limitations}",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".bonus.content": "[tip_tip1] Testo per il bonus {coupon_limitations}",
        str("tip_" + mkauto_consts.random_code["tip1"]) + ".text.content": "[tip_tip1] Testo per il premio libero {coupon_limitations}",
        ...
        # tip_tip1 }}}
        # tip_tip2 {{{
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".discount.subject": "[tip_tip2] grazie per la tua registrazione, ecco uno sconto del {prize_val}%",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".bonus.subject": "[tip_tip2] grazie per la tua registrazione, ecco un bonus di €{prize_val}",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".text.subject": "[tip_tip2] grazie per la tua registrazione, ecco {prize_val}",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".discount.title": "[tip_tip2] grazie per la tua registrazione,<br />ecco uno sconto del {prize_val}%",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".bonus.title": "[tip_tip2] grazie per la tua registrazione,<br />ecco un bonus di €{prize_val}",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".text.title": "[tip_tip2] grazie per la tua registrazione, ecco<br />{prize_val}",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".discount.content": "[tip_tip2] Testo per lo sconto {coupon_limitations}",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".bonus.content": "[tip_tip2] Testo per il bonus {coupon_limitations}",
        str("tip_" + mkauto_consts.random_code["tip2"]) + ".text.content": "[tip_tip2] Testo per il premio libero {coupon_limitations}",
