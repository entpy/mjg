...
class MkautoStrings(object):
    strings = {
        ...
        str(mkauto_consts.event_code["happy_birthday_prize"]) + ".discount.content": "Buon compleanno, per questa giornata speciale vogliamo farti un regalo dedicato solo a te. Ecco sconto del {prize_val}%. Ti aspettiamo in officina ({business_address}).",
        str(mkauto_consts.event_code["happy_birthday_prize"]) + ".bonus.content": "Buon compleanno, per questa giornata speciale vogliamo farti un regalo dedicato solo a te. Ecco un bonus di €{prize_val}. Ti aspettiamo in officina ({business_address}).",
        str(mkauto_consts.event_code["happy_birthday_prize"]) + ".text.content": "Buon compleanno, per questa giornata speciale vogliamo farti un regalo dedicato solo a te. Ecco {prize_val}. Ti aspettiamo in officina ({business_address}).",
