                                ...
                                <td valign="top" align="center">
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tbody>
                                                        ...
                                                        <img class="emailMainLogo" src='""" + str(settings.SITE_URL) + """/static/website/img/email_logo.png' alt="MotorJab Garage" style="width:100%; max-width:""" + str(logo_width) + """px;height:auto; display:block;" border="0" width='""" + str(logo_width) + """'>
                                                        </a>
                                                        </td>
                                                        </tr>
                                                </tbody>
                ...
                <tr>
                        <td style="padding-bottom:20px;" class="description" valign="top" align="center">
                                <table style="width: 100%; border-top: 1px solid #cccaca; border-bottom: 1px solid #cccaca;">
                                        <tr>
                                                <td style="text-align: center; padding-top: 10px;"><p class="text emailCampaignDiscountTitle fallback-text" style="color:#333;font-family:'sans-serif', Helvetica, Arial;font-size:13px;font-weight:300;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;">Costava</p></td>
                                                <td style="text-align: center; padding-top: 10px;"><p class="text emailCampaignDiscountTitle fallback-text" style="color:#333;font-family:'sans-serif', Helvetica, Arial;font-size:13px;font-weight:300;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;">Sconto</p></td>
                                                <td style="text-align: center; padding-top: 10px;"><p class="text emailCampaignDiscountTitle fallback-text" style="color:#333;font-family:'sans-serif', Helvetica, Arial;font-size:13px;font-weight:300;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;">Risparmi</p></td>
                                        </tr>
                                        <tr>
                                                <td style="text-align: center; padding-bottom: 10px;"><span class="text emailCampaignDiscounturrency fallback-text" style="color:#333;font-family:'sans-serif', Helvetica, Arial;font-size:18px;font-weight:100;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;margin-right: 5px;">""" + str(currency) + """</span><span class="text emailCampaignDiscountValue fallback-text" style="color:#333;font-family:'sans-serif', Helvetica, Arial;font-size:25px;font-weight:100;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;">""" + str(was_price) + """</span></td>
                                                <td style="text-align: center; padding-bottom: 10px;"><span class="text emailCampaignDiscountValue fallback-text" style="color:#333;font-family:'sans-serif', Helvetica, Arial;font-size:25px;font-weight:400;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;">""" + str(discount) + """%</span></td>
            ...
            return_var += """
                <tr>
                        <td style="padding-bottom:50px;" class="description" valign="top" align="center">
                                <table style="width: 100%;">
                                        <tr>
                                                <td style="text-align: center; padding-top: 10px;"><p class="text emailCampaignDiscountTitle fallback-text" style="color:#ff0505;font-family:'sans-serif', Helvetica, Arial;font-size:13px;font-weight:300;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;">Affrettati, scade tra</p></td>
                                        </tr>
                                        <tr>
                                                <td style="text-align: center; padding-bottom: 10px;"><span class="text emailCampaignDiscountValue fallback-text" style="color:#ff0505;font-family:'sans-serif', Helvetica, Arial;font-size:25px;font-weight:100;font-style:normal;letter-spacing:normal;text-transform:none;text-align:center;padding:0;margin:0;">""" + str(expiring_str) + """</span></td>
                                        </tr>
                                </table>
                        </td>
                </tr>
