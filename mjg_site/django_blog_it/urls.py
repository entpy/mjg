...
urlpatterns = [
    ...
    url(r'^dashboard/bulk_actions_blog/$', BlogPostBulkActionsView.as_view(), name='bulk_actions_blog'),
    ...
    # pages
    url(r'^dashboard/bulk_actions_category/$', CategoryBulkActionsView.as_view(), name='bulk_actions_category'),

    url(r'^dashboard/pages/$', PagesListView.as_view(), name='pages'),
    url(r'^dashboard/pages/add/$', PageCreateView.as_view(), name='add_page'),
    url(r'^dashboard/pages/edit/(?P<page_slug>[-\w]+)/$', PageUpdateView.as_view(), name='edit_page'),
    url(r'^dashboard/pages/update/(?P<page_slug>[-\w]+)/$', page_status_update, name='page_status_update'),
    url(r'^dashboard/pages/delete/(?P<page_slug>[-\w]+)/$', PageDeleteView.as_view(), name='delete_page'),
    url(r'^dashboard/bulk_actions_pages/$', BulkActionsPageView.as_view(), name='bulk_actions_pages'),
    ...
    url(r'^dashboard/user/edit/(?P<pk>[-\w]+)/user_role/$', edit_user_role, name='edit_user_role'),
    url(r'^dashboard/user/delete/(?P<pk>[-\w]+)/$', UserDeleteView.as_view(), name='delete_user'),
    url(r'^dashboard/bulk_actions_users/$', UserBulkActionsView.as_view(), name='bulk_actions_users'),
    ...
    url(r'^dashboard/bulk_actions_menu/$', MenuBulkActionsView.as_view(), name='bulk_actions_menu'),

    # themes management
    url(r'^dashboard/themes/$', ThemesList.as_view(), name='themes'),
    # url(r'^dashboard/themes/add/$', add_theme, name='add_theme'),
    url(r'^dashboard/themes/add/$', ThemeCreateView.as_view(), name='add_theme'),
    url(r'^dashboard/themes/(?P<theme_slug>[-\w]+)/$', ThemeDetailView.as_view(), name='view_theme'),
    url(r'^dashboard/themes/edit/(?P<pk>[0-9]+)/$', ThemeUpdateView.as_view(), name='edit_theme'),
    # url(r'^dashboard/themes/edit/(?P<theme_slug>[-\w]+)/$',
    #     edit_theme, name='edit_theme'),
    url(r'^dashboard/themes/delete/(?P<pk>[-\w]+)/$', DeleteThemeView.as_view(), name='delete_theme'),
    # url(r'^dashboard/themes/delete/(?P<theme_slug>[-\w]+)/$',
    #     delete_theme, name='delete_theme'),
    url(r'^dashboard/bulk_actions_themes/$', ThemesBulkActionsView.as_view(), name='bulk_actions_themes'),

    url(r'^dashboard/themes/update/(?P<theme_slug>[-\w]+)/$', theme_status_update, name='theme_status_update'),

    url(r'^dashboard/contactUs/$', configure_contact_us, name='configure_contact_us'),
    ...
    url(r'^(?P<year>\w{0,})/(?P<month>\w{0,})/$', ArchiveView.as_view(), name='archive_posts'),
    url(r'^post/(?P<blog_slug>[-\w]+)/$', BlogPostView.as_view(), name='blog_post_view'),
